...
export const BackgroundBeamsWithCollision = ({
  ...
  return (
    (<div
      ref={parentRef}
      className={cn(
        "  h-96 md:h-[40rem] bg-[url('https://res.cloudinary.com/dwyn5jgh3/image/upload/v1737702036/blk3_m60tkw.jpg')] bg-no-repeat bg-cover relative flex items-center  justify-center overflow-hidden",
